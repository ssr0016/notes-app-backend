...
// Edit Note
app.put("/edit-note/:noteId", authentication, async (req, res) => {
...
// Get All Notes
app.get("/get-all-notes", authentication, async (req, res) => {
  const { user } = req.user;
...
// Delete Note
app.delete("/delete-note/:noteId", authentication, async (req, res) => {
  const noteId = req.params.noteId;
  const { user } = req.user;
...
app.put("/update-note-pinned/:noteId", authentication, async (req, res) => {
  const noteId = req.params.noteId;
...
// Search Notes
app.get("/search-notes/", authentication, async (req, res) => {
  const { user } = req.user;
